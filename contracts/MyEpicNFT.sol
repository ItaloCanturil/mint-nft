...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["STRESSout", "happy", "Stuff", "water", "DOG", "Bitcoio", "Primo", "Joel", "Stay", "WaterBottle", "SellOntheDownMarket", "DooClosed", "Cry", "Loser", "Strong"];
      ...
      bytes(
        string(
          abi.encodePacked(
            '{"name": "',
              combinedWord,
              '", "descripition": "A highly incredible primo square", "image": "data:image/svg+xml;base64,',
